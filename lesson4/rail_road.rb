class RailRoad
  def initialize
    # @stations = [Station.new('Липецк'), Station.new('Москва'), Station.new('Уфа')]
    # @routes = [Route.new(@stations[0], @stations[2])]
    # @trains = [PassengerTrain.new('059A')]
    # @wagons = [PassengerWagon.new('p00001'), CargoWagon.new('c00001')]
    @stations = []
    @routes = []
    @trains = []
    @wagons = []
  ...
  # интерфейс класса - главное меню, для прямого вызова остальные функции не доступны
